...
export default function newpost() {
  ...
  return (
    <div className="mt-14 max-w-5xl m-auto py-10 px-4 text-zinc-200">
      <div className="mb-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="max-w-full flex">
          <textarea rows="12" required cols="30" placeholder="Escreva seu post aqui" style={{ resize: 'none' }} value={content} onChange={(e) => setContent(e.target.value)} className="p-4 w-full rounded bg-black border border-zinc-700 focus:outline-none focus:border-purple focus:border-2" />
          <ReactMarkdown
          components={{
