            ...
            <div className="flex items-center px-2 max-w-7xl mx-auto h-14">
                <span className="hidden max-md:flex items-center">
                   <button className="mx-2 p-2">
                        <svg className="fill-zinc-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="atno4p6s0vyo8u1vyz9t1ta9pft0yuex" class="crayons-icon"><title id="atno4p6s0vyo8u1vyz9t1ta9pft0yuex">Navigation menu</title>
                ...
                <div className="flex items-center h-100 ml-auto">
                    ...
                    <a href="/notifications" className="mx-1 p-2 hover:bg-indigo-900/75 rounded">
                        <svg className="fill-zinc-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aobclc8t32pcofcuray898alv5kfn144" class="crayons-icon"><title id="aobclc8t32pcofcuray898alv5kfn144">Notifications</title>
